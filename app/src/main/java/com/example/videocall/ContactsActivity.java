...
//        myContactsList.setHasFixedSize(true);
        ...
        findPeopleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent findUserIntent = new Intent(ContactsActivity.this, findPeopleActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Contacts> options
                ...
                .setQuery(contactsReference.child(currentUserId), Contacts.class).build();

        FirebaseRecyclerAdapter<Contacts, ContactsViewHolder> firebaseRecyclerAdapter
                = new FirebaseRecyclerAdapter<Contacts, ContactsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final ContactsViewHolder holder, int i, @NonNull Contacts contact) {
